                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            mySnackBar(context, title: "asdads");
                            try {
                              final uri = Uri.parse(
                                "https://notifychiefonjoin-56aeyway6a-uc.a.run.app",
                              );
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    if (index == 0) {
                                      ...
                                      // final userName = await AppStorage.read(
                                      //   key: "name",
                                      // );
                                      // log("asdadadasdasd $userName");
